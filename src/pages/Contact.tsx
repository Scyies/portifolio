...
export default function Contact() {
  ...
  return (
    <main className='text-white my-20 mx-6 md:mx-28 lg:mx-40 lg:flex lg:place-items-center lg:justify-between'>
      <section className='my-8 lg:flex lg:justify-around lg:w-[65%]'>
        <div className='lg:w-[40%]'>
          ...
          <p className='text-gray md:text-2xl my-4'>
            ...
            minhas{' '}
            <strong className='font-medium text-orange'> redes sociais.</strong>
          </p>
        </div>
        <div className='flex justify-center my-8 lg:flex-col lg:mx-8'>
          ...
          >
            <img
              src={linkedinLogo}
              alt=''
              className='w-8 h-8 mr-8 md:mr-12 md:w-12 md:h-12 lg:mb-8'
            />
          </a>
      ...
      <form
        action='https://formspree.io/f/xpzbnjzj'
        className='mb-8 lg:w-[30%]'
        method='POST'
      >
        ...
        <div className='h-full w-full mt-4'>
          <label htmlFor='mensagem' className='font-bold'>
            Mensagem
          </label>
          <textarea
            name='mensagem'
