    ...
    <main className="text-white mx-6 md:mx-8 lg:mx-40">
      <section className="flex flex-col lg:mx-20 text-white mt-4 min-h-[calc(100vh-112px)] justify-around">
        <div className="lg:max-w-2xl">
          <div className="bg-orange h-1 md:h-2 w-10 md:w-20 mb-2"></div>
          <h1 className="font-bold text-xl md:text-5xl lg:my-8">
            <span className="flex">Olá,</span> Sou <span className="text-orange">Sérgio E. Valerio</span>,
            Desenvolvedor Front-End
          </h1>
          <p className="text-gray text-md md:text-2xl my-4 lg:my-8 font-medium">
            Atualmente morando no Brasil, criando sites
            <span className="text-orange ml-1 font-medium">
              interativos
            </span>{" "}
      ...
      <section className="mt-12 flex flex-col md:flex-row justify-between">
        <div className="lg:flex flex-col lg:max-w-[40vw]">
          ...
          <p className="text-gray my-4 font-medium md:text-xl">
            Para maiores{" "}
            <span className="font-medium text-orange">detalhes</span>,
      ...
      <section className="my-16 font-medium md:text-xl md:flex md:justify-around lg:place-items-center">
        <img src={laptopEarth} alt="" className="hidden lg:flex lg:min-w-[50vw] lg:h-full self-center" />
      ...
      <section className="bg-gray flex flex-col md:flex-row justify-center my-6 -mx-6 lg:-mx-40">
        <div className="flex flex-col md:flex-row justify-center lg:mx-40">
          <div className="text-center p-6 lg:pl-0 md:text-left md:p-12 lg:flex lg:flex-col lg:justify-around">
            <h3 className="font-bold text-xl md:text-2xl lg:text-3xl">
              Aqui estão alguns de meus projetos
            </h3>
            <Link to="/projetos" className="flex justify-center md:justify-start text-xl md:text-2xl">
      ...
      <section className="min-h-[70vh] flex flex-col lg:flex-row lg:place-items-center justify-center">
        ...
        <Link to="/contato" className="flex justify-center text-xl md:text-3xl mt-4">
