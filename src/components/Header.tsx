  ...
  return (
    <header className='mx-6 md:mx-8 lg:mx-40 md:flex place-items-center justify-between'>
      ...
      <nav className='flex justify-center text-white lowercase text-md md:text-xl lg:text-3xl list-none'>
        <Link to='/' id='nav__hover' className='mr-4 md:mr-8 lg:mr-12'>
          Home
        </Link>
        <Link to='/projetos' className='mr-4 md:mr-8 lg:mr-12' id='nav__hover'>
          Projetos
        </Link>
        <Link to='/contato' className='' id='nav__hover'>
          Contato
        </Link>
      </nav>
    </header>
